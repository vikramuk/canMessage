...
def test_periodic_send_with_modifying_data(bus): 
   ...
   print("done")
         ...
         # task = can.interface.MultiRateCyclicSendTask('vcan0', msg, 10, 0.001, 0.50) 84 # time.sleep(2) 
...
if __name__ == "__main__":
   ...
   for interface, channel in [ ('socketcan_ctypes', 'can0')]:
   ...
   #can.rc['interface'] = interface 128 #test_dual_rate_periodic_send()
   bus.shutdown()
   time.sleep(2)
